...
function processPost (post) {
  ...
  console.log(`${post['wp:post_name']} ${post['wp:post_name'][0].length} \n`)
  ...
  var fullPath = path.join('out', postDate.getFullYear().toString(), getPaddedMonthNumber(postDate.getMonth() + 1))  // 'out\\' + postDate.getFullYear() + '\\' + getPaddedMonthNumber(postDate.getMonth() + 1) + '\\' + slug

  console.log(fullPath)
  mkdirp(path.join('out', postDate.getFullYear().toString(), getPaddedMonthNumber(postDate.getMonth() + 1)), (err, made) => {
  	console.log(err, made)
  // fs.mkdir('out\\' + postDate.getFullYear(), function () {
    ...
    fs.writeFile(path.join(fullPath, slug) + '.md', header + markdown, function (err) {
